...
Đội ngũ chuyên gia của chúng tôi sẽ đánh giá hàng hóa và đề xuất giải pháp phù hợp nhất!`,
  ...
  const partners = [
    ...
    { name: 'YANG MING', port: 'Cảng Vũng Tàu', type: 'SHIPPING', sortOrder: 7, logoUrl: 'https://via.placeholder.com/200x80?text=YANG+MING' },
    { name: 'ONE', port: 'Cảng Vũng Tàu', type: 'SHIPPING', sortOrder: 8, logoUrl: 'https://via.placeholder.com/200x80?text=Ocean+Network+Express' },
    { name: 'HANJIN', port: 'Cảng Hồ Chí Minh', type: 'SHIPPING', sortOrder: 9, logoUrl: 'https://via.placeholder.com/200x80?text=HANJIN' },
    { name: 'KLINE', port: 'Cảng Đà Nẵng', type: 'SHIPPING', sortOrder: 10, logoUrl: 'https://via.placeholder.com/200x80?text=KLINE' },
    { name: 'PIL', port: 'Cảng Hải Phòng', type: 'SHIPPING', sortOrder: 11, logoUrl: 'https://via.placeholder.com/200x80?text=PIL' },
    ...
    { name: 'MOL', port: 'Cảng Vũng Tàu', type: 'SHIPPING', sortOrder: 13, logoUrl: 'https://via.placeholder.com/200x80?text=MOL' },
    { name: 'UASC', port: 'Cảng Hồ Chí Minh', type: 'SHIPPING', sortOrder: 14, logoUrl: 'https://via.placeholder.com/200x80?text=UASC' },
    { name: 'WANHAI', port: 'Cảng Đà Nẵng', type: 'SHIPPING', sortOrder: 15, logoUrl: 'https://via.placeholder.com/200x80?text=WANHAI' },
    { name: 'NAMSUNG', port: 'Cảng Hải Phòng', type: 'SHIPPING', sortOrder: 16, logoUrl: 'https://via.placeholder.com/200x80?text=NAMSUNG' },
    { name: 'HEUNG-A', port: 'Cảng Hồ Chí Minh', type: 'SHIPPING', sortOrder: 17, logoUrl: 'https://via.placeholder.com/200x80?text=HEUNG-A' },
    // Airlines
    ...
    { name: 'BAMBOO', port: 'Hàng không', type: 'AIRLINE', sortOrder: 22, logoUrl: 'https://via.placeholder.com/200x80?text=BAMBOO' },
    // International Partner
    { name: 'WCA', port: 'Đối tác quốc tế', type: 'INTERNATIONAL', sortOrder: 23, logoUrl: 'https://via.placeholder.com/200x80?text=WCA' },
  ]
